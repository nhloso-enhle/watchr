    ...
    <div className="min-h-screen relative flex items-center justify-center p-4"
      ...
      <div className="relative w-full max-w-sm anim-scale" style={{ zIndex: 1 }}>
        ...
        <div className="card px-7 py-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required value={form.identifier} onChange={set('identifier')}
        ...
        <p className="text-center mt-5 text-sm" style={{ color: 'var(--text-3)' }}>
          ...
          <Link to="/register" className="font-semibold hover:opacity-70" style={{ color: 'var(--accent)' }}>
            Sign up
          </Link>
        </p>
      </div>
