...
export default function Explore() {
  ...
  const showTrending = !searched && !loading;
  const trendPaged   = trending.slice(0, PER_PAGE);
  ...
  return (
    <div className="min-h-screen page" style={{ background: 'var(--bg)' }}>
      ...
      {/* Hero search */}
      <div
        className="relative overflow-hidden py-10 sm:py-12 px-4 sm:px-6"
      ...
      >
        ...
        <div className="relative max-w-xl mx-auto text-center">
          <h1 className="font-bold mb-2"
            style={{ fontSize: 'clamp(1.5rem, 5vw, 1.85rem)', color: 'var(--text)', letterSpacing: '-0.02em' }}>
            Discover Your Next Watch
          </h1>
          <p className="mb-6 text-sm" style={{ color: 'var(--text-2)' }}>
            Powered by TMDB — millions of movies and TV shows
          </p>
